...
export default function SquadDetailPage() {
  ...
  const RULE_META: Record<string, { label: string; desc: string }> = {
    ...
    GROUP_CLASSIFIED:      { label: "Equipo clasificado del grupo", desc: "Puntos por cada equipo que predijiste que pasaba de fase (1° o 2°), sin importar la posición" },
    ...
    GROUP_THIRD_QUALIFIED: { label: "3° que avanza como mejor tercero", desc: "En 2026 hay 12 grupos: los 8 mejores terceros también clasifican. Puntos si acertaste el tercer equipo de un grupo que logró avanzar" },
    ROUND_OF_32:      { label: "Ganador en Ronda de 32", desc: "Por cada equipo que predijiste correctamente como ganador de su partido en la ronda de 32" },
    ROUND_OF_16:      { label: "Ganador en Octavos", desc: "Por cada equipo que predijiste correctamente como ganador de su partido en octavos de final" },
    QUARTER_FINALS:   { label: "Ganador en Cuartos", desc: "Por cada equipo que predijiste correctamente como ganador de su partido en cuartos de final" },
    SEMI_FINALS:      { label: "Ganador en Semis", desc: "Por cada equipo que predijiste correctamente como ganador de su partido en las semifinales" },
    CHAMPION:         { label: "Campeón del mundo", desc: "Si predijiste al campeón del torneo" },
